...
<c:if test="${!empty sessionScope.message}">
 ...
 <form method="POST" action="/ASSM_SOF3011/users/store" style="padding-left: 10%;padding-right: 10%;">
        <div class="mb-3">
        ...
        <div style="margin-top:10px">
            ...
            <input type="radio" name="roll"  value="1"  checked/>
            <label>Người Dùng</label>
            <input type="radio" name="roll"  value="0"  />
            <label>Admin</label>
        </div>
